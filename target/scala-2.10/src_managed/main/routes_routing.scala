...
// @LINE:13
private[this] lazy val controllers_Application_deleteTask3 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tasks/"),DynamicPart("id", """[^/]+""",true),StaticPart("/delete"))))
...
case controllers_Application_deleteTask3(params) => {
   call(params.fromPath[String]("id", None)) { (id) =>
        invokeHandler(controllers.Application.deleteTask(id), HandlerDef(this, "controllers.Application", "deleteTask", Seq(classOf[String]),"GET", """ original is post
POST    /tasks/:id/delete       	controllers.Application.deleteTask(id: String)""", Routes.prefix + """tasks/$id<[^/]+>/delete"""))
   }
}
